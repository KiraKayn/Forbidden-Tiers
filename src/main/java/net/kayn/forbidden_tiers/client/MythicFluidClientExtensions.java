...
public class MythicFluidClientExtensions implements IClientFluidTypeExtensions {
    ...
    private static final ResourceLocation STILL =
            ResourceLocation.fromNamespaceAndPath("forbidden_tiers", "block/mythic_ink_still");
    private static final ResourceLocation FLOW =
            ResourceLocation.fromNamespaceAndPath("forbidden_tiers", "block/mythic_ink_flow");
