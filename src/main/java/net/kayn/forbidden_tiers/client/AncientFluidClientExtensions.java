...
public class AncientFluidClientExtensions implements IClientFluidTypeExtensions {
    ...
    private static final ResourceLocation STILL =
            ResourceLocation.fromNamespaceAndPath("forbidden_tiers", "block/ancient_ink_still");
    private static final ResourceLocation FLOW =
            ResourceLocation.fromNamespaceAndPath("forbidden_tiers", "block/ancient_ink_flow");
