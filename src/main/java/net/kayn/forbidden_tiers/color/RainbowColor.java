...
public class RainbowColor extends TextColor {
    ...
    public static final int FALLBACK_COLOR = 0xFF00FF;

    public static final RainbowColor INSTANCE = new RainbowColor(1.0f);

    private final float speed;

    public RainbowColor(float speed) {
        super(FALLBACK_COLOR, "ft_rainbow");
        this.speed = speed;
    }
    ...
    public int getValue() {
        if (FMLEnvironment.dist == Dist.CLIENT) {
            return RAINBOW_GRADIENT[(int) ((getClientTick() * speed) % RAINBOW_GRADIENT.length)];
        }
        return FALLBACK_COLOR;
    }

    private static long getClientTick() {
        return ClientTickHolder.getTick();
    }

    public static class ClientTickHolder {
